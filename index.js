...
class ChatBase{static url="https://www.chatbase.co";static supports_gpt_35_turbo=!0;static supports_gpt_4=!0;static working=!0;static async*createAsyncGenerator(t,e,s){let a="";if("gpt-4"===t)a="quran---tafseer-saadi-pdf-wbgknt7zn";else{if("gpt-3.5-turbo"!==t&&t)throw new Error(`Model are not supported: ${t}`);a="chatbase--1--pdf-p680fxvnm"}const r={"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36",Accept:"*/*","Accept-language":"en,fr-FR;q=0.9,fr;q=0.8,es-ES;q=0.7,es;q=0.6,en-US;q=0.5,am;q=0.4,de;q=0.3",Origin:this.url,Referer:this.url+"/","Sec-Fetch-Dest":"empty","Sec-Fetch-Mode":"cors","Sec-Fetch-Site":"same-origin"},c={messages:e,captchaCode:"hadsa",chatId:a,conversationId:`kcXpqEnqUie3dnJlsRi_O-${a}`};try{const t=await axios.post(`${this.url}/api/fe/chat`,c,{headers:r});if(200!==t.status)throw new Error(`ChatBase request failed with status code: ${t.status}`);const e=t.data;yield e}catch(t){throw console.error("Error:",t),t}}}																																																																																																																																																																																																			
