...
const anu = await axios.post("https://snapinst.com/api/convert", {"url":link,"ts":1707528919262,"_ts":1707465201653,"_tsc":0,"_s":"fc7e152a016fa03acc2b9ee54ff68bbfe701d6be0686fcdf43d07d7d95336168"}, {
  headers: {
    'Content-Type': 'application/x-www-form-urlencoded',
    'User-Agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36'
  }
});
var result = {title:anu.data.meta.title, thumbnail:anu.data.thumb, url:anu.data.url[0].url}
return result
}
