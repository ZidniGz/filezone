...
const cocofun=(async s=>new Promise((t,e)=>{axios({url:s,method:"get",headers:{Cookie:"client_id=1a5afdcd-5574-4cfd-b43b-b30ad14c230e","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.0.0 Safari/537.36"}}).then(s=>{let e;$=cheerio.load(s.data);const o=$("script#appState").get();for(let s of o){s.children&&s.children[0]&&s.children[0].data&&(ress=s.children[0].data.split("window.APP_INITIAL_STATE=")[1],e=JSON.parse(ress));const o={title:e.share.post.post.content?e.share.post.post.content:e.share.post.post.topic.topic,play:e.share.post.post.playCount,quality:"480p",like:e.share.post.post.likes,share:e.share.post.post.share,duration:e.share.post.post.videos[e.share.post.post.imgs[0].id].dur,thumbnail:e.share.post.post.videos[e.share.post.post.imgs[0].id].coverUrls[0],url:e.share.post.post.videos[e.share.post.post.imgs[0].id].urlext};t(o)}}).catch(e)}))
